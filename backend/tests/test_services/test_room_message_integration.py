...
class TestRoomMessageIntegration:
    ...
    @pytest.fixture
    def room_service_with_mocks(self, mock_room_repository, mock_user_repository, mock_message_repository):
    ...
    @pytest.mark.asyncio
    async def test_create_room_and_send_welcome_message(self, integration_services, mock_room_repository, mock_user_repository, mock_message_repository):
        """測試創建房間後發送歡迎消息的整合流程"""
    ...
    @pytest.mark.asyncio
    async def test_join_room_and_send_join_message(self, integration_services, mock_room_repository, mock_user_repository, mock_message_repository):
        """測試加入房間後發送加入消息的整合流程"""
        room_service = integration_services['room_service']
        message_service = integration_services['message_service']
    ...
    @pytest.mark.asyncio
    async def test_delete_room_with_message_cleanup(self, integration_services, mock_room_repository, mock_user_repository, mock_message_repository):
        """測試刪除房間時清理消息的整合流程"""
        room_service = integration_services['room_service']
        message_service = integration_services['message_service']
        ...
        mock_message_repository.delete_by_room_id = AsyncMock(return_value=15)  # 刪除了15條消息
    ...
    @pytest.mark.asyncio
    async def test_send_message_with_room_validation(self, integration_services, mock_room_repository, mock_user_repository, mock_message_repository):
        """測試發送消息時的房間驗證整合流程"""
        room_service = integration_services['room_service']
        message_service = integration_services['message_service']
    ...
    @pytest.mark.asyncio
    async def test_room_member_validation_for_message_sending(self, integration_services, mock_room_repository, mock_user_repository, mock_message_repository):
        """測試非成員發送消息時的驗證流程"""
        room_service = integration_services['room_service']
        message_service = integration_services['message_service']
    ...
    @pytest.mark.asyncio
    async def test_get_room_messages_integration(self, integration_services, mock_room_repository, mock_message_repository):
        """測試獲取房間消息的整合流程"""
        room_service = integration_services['room_service']
        message_service = integration_services['message_service']
        ...
        mock_message_repository.get_room_messages.assert_called_once_with(room_id=room_id, skip=0, limit=20, message_type=None, user_id=None)
    
    @pytest.mark.asyncio
    async def test_error_handling_in_room_message_integration(self, integration_services, mock_room_repository, mock_message_repository):
        """測試房間消息整合中的錯誤處理"""
        room_service = integration_services['room_service']
        message_service = integration_services['message_service']
