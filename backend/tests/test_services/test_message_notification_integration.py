...
class TestMessageNotificationIntegration:
    ...
    async def test_reply_message_with_targeted_notification(
        ...
        # 配置 user_repo mock
        message_service.user_repo.get_by_id = AsyncMock(return_value=reply_sender)
    ...
    async def test_private_message_notification(
        ...
        # 配置 user_repo mock
        message_service.user_repo.get_by_id = AsyncMock(return_value=sender)
    ...
    async def test_error_handling_in_message_notification_integration(
        ...
        # 配置 user_repo mock
        message_service.user_repo.get_by_id = AsyncMock(return_value=user)
