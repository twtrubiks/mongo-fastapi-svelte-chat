...
class TestCoreExceptionsEnhanced:
    ...
    def test_base_custom_exception_basic(self):
        ...
        exception = BaseCustomError(message)
    ...
    def test_base_custom_exception_with_details(self):
        ...
        exception = BaseCustomError(message, details)
    ...
    def test_base_custom_exception_none_details(self):
        ...
        exception = BaseCustomError(message, None)
    ...
    def test_exception_inheritance_chain(self):
        ...
        for exc_class in exceptions:
            assert issubclass(exc_class, BaseCustomError)
    ...
    def test_exception_chaining(self):
        ...
        try:
            ...
            assert isinstance(db_error, BaseCustomError)
