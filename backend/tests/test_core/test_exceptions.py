...
class TestBaseCustomError:
    """測試 BaseCustomError"""

    def test_base_exception_with_message_only(self):
        """測試只有訊息的基礎異常"""
        exception = BaseCustomError("Test error message")
    ...
    def test_base_exception_with_message_and_details(self):
        ...
        exception = BaseCustomError("Validation failed", details)
...
class TestSpecificExceptions:
    ...
    def test_business_logic_error(self):
        ...
        assert isinstance(exception, BaseCustomError)
    ...
    def test_database_error(self):
        ...
        exception = DatabaseError(
            "Connection failed", {"host": "localhost", "port": 27017}
        )
    ...
    def test_external_service_error(self):
        ...
        exception = ExternalServiceError(
            "API timeout", {"service": "payment", "timeout": 30}
        )
    ...
    def test_rate_limit_error(self):
        ...
        exception = RateLimitError(
            "Too many requests", {"limit": 100, "window": "1min"}
        )
