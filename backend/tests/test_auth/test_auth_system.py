...
class TestAuthSystem:
    ...
    async def test_get_current_user_dependency(self):
        ...
        # Mock get_database
        with patch('app.auth.dependencies.get_database', new_callable=AsyncMock) as mock_get_db:
            mock_get_db.return_value = mock_db
            
            # 創建 TokenData
            token_data = TokenData(username="testuser", user_id="507f1f77bcf86cd799439011")
