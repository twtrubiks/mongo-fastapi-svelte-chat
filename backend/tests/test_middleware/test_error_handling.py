...
class TestGlobalErrorHandlerAdditional:
    ...
    async def test_log_levels(self):
        ...
        error_detail = ErrorDetail("TEST_ERROR", "Test message", 500)
    ...
    def test_error_detail_class(self):
        """測試 ErrorDetail 類別"""
        detail = ErrorDetail("TEST_CODE", "Test message", 400)
        ...
        # 測試帶詳細信息的情況
        details = {"field": "value"}
        detail = ErrorDetail("TEST_CODE", "Test message", 500, details)
