...
class TestErrorHandlingMiddleware:
    ...
    async def test_async_middleware_chain(self):
        ...
        mock_handler.handle = AsyncMock(return_value=JSONResponse(
            status_code=400,
...
class TestGlobalErrorHandlerAdditional:
    ...
    def app_auth_errors(self):
        ...
        from fastapi import FastAPI
        from app.middleware.error_handler import GlobalErrorHandler
        from app.core.exceptions import UnauthorizedError, ForbiddenError, ConflictError
    ...
    async def test_log_levels(self):
        """測試不同錯誤的日誌級別"""
        from app.middleware.error_handler import GlobalErrorHandler, ErrorDetail
        from fastapi import Request
    ...
    def test_create_error_handler_middleware_function(self):
        """測試便利函數"""
        from app.middleware.error_handler import create_error_handler_middleware, GlobalErrorHandler
