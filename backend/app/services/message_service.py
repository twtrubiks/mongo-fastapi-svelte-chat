...
from app.models.message import (
    MessageCreate, MessageInDB, MessageResponse, MessageUpdate,
    MessageListResponse, MessageWithReply, MessageStats, MessageType, MessageStatus,
    ReplyToMessage, MessageSearchQuery
)
...
class MessageService:
    ...
    def __init__(self, message_repository: MessageRepository, room_repository: RoomRepository):
    ...
    async def create_message(
        ...
        try:
            ...
            if "創建訊息失敗" in str(e):
                ...
                raise Exception(f"創建訊息失敗: {str(e)}")
    
    async def get_message_by_id(self, message_id: str) -> Optional[MessageWithReply]:
        """
        根據 ID 獲取訊息
