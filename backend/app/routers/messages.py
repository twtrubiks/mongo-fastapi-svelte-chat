...
from app.models.message import MessageCreate, MessageResponse, MessageUpdate, MessageSearchQuery
...
async def update_message(
    ...
    try:
        ...
        updated_message = await message_service.update_message(message_id, current_user_id, message_update)
