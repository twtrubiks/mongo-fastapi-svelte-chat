...
async def get_notifications(
    ...
    status: Optional[NotificationStatus] = Query(None, description="過濾狀態"),
    type: Optional[NotificationType] = Query(None, description="過濾類型"),
    ...
    try:
        ...
        notifications = notification_list_response.notifications
...
async def get_unread_notifications(
    ...
    try:
        ...
        notifications = notification_list_response.notifications
        total = notification_list_response.total
