...
class Validators:
    ...
    def validate_email(email: str) -> bool:
        ...
        try:
            ...
            raise ValidationError(f"無效的電子郵件地址: {str(e)}") from e
    ...
    def validate_phone(phone: str) -> bool:
        ...
        """
        return Validators.validate_string(
            phone, min_length=9, max_length=15, pattern=Validators.PATTERNS["phone"]
        )
    ...
    def validate_url(url: str) -> bool:
        ...
        Raises:
            ValidationError: 驗證失敗
        """
        return Validators.validate_string(url, pattern=Validators.PATTERNS["url"])
        ...
        if item_validator:
            for i, item in enumerate(value):
                try:
                    ...
                    raise ValidationError(f"列表項目 {i}: {str(e)}") from e
    ...
    def validate_dict(
        ...
        key_validators: dict[str, callable] | None = None,
    ) -> bool:
        """
        驗證字典
            ...
            for key, validator in key_validators.items():
                if key in value:
                    try:
                        ...
                        raise ValidationError(f"鍵 '{key}': {str(e)}") from e
    ...
    def validate_date(
        ...
        if isinstance(value, str):
            try:
                ...
                raise ValidationError(f"無效的日期格式，應為 {date_format}") from e
    ...
    def validate_ip_address(ip: str) -> bool:
        ...
        Raises:
            ValidationError: 驗證失敗
        """
        return Validators.validate_string(ip, pattern=Validators.PATTERNS["ip_address"])
    ...
    def validate_uuid(uuid_string: str) -> bool:
        ...
        """
        return Validators.validate_string(
            uuid_string, pattern=Validators.PATTERNS["uuid"]
        )
    ...
    def validate_hex_color(color: str) -> bool:
        ...
        """
        return Validators.validate_string(
            color, pattern=Validators.PATTERNS["hex_color"]
        )
    ...
    def validate_slug(slug: str) -> bool:
        ...
        """
        return Validators.validate_string(
            slug, min_length=1, max_length=50, pattern=Validators.PATTERNS["slug"]
        )
    ...
    def validate_and_sanitize(
        value: str, validator_func: callable, sanitize: bool = True
    ) -> str:
        """
        驗證並清理字符串
...
def validate_user_input(
    ...
    if full_name:
        cleaned_data["full_name"] = Validators.validate_and_sanitize(
            full_name,
            lambda x: Validators.validate_string(x, min_length=2, max_length=50),
        )
...
def validate_message_content(content: str) -> str:
    ...
    return Validators.validate_and_sanitize(
        content, lambda x: Validators.validate_string(x, min_length=1, max_length=10000)
    )
...
def validate_room_name(name: str) -> str:
    ...
    """
    return Validators.validate_and_sanitize(
        name, lambda x: Validators.validate_string(x, min_length=1, max_length=50)
    )
