...
class RateLimitingMiddleware(BaseHTTPMiddleware):
    ...
    def __init__(
        self, app, redis_client: redis.Redis = None, settings: Settings = None
    ):
        super().__init__(app)
        ...
        if self.settings.DEBUG:
            ...
            self.rate_limits = {
                ...
                "/api/": {
                    ...
                    "burst": self.settings.RATE_LIMIT_BURST_SIZE,
                },
                # 檔案上傳 - 較寬鬆但有突發限制
                "/api/files/upload": {
                    "window": 300,
    ...
    async def _initialize_limiter(self) -> bool:
        ...
        if self.limiter is None and self.redis_client is None:
            ...
            except Exception as e:  # intentional catch-all: rate limiting fail-open，初始化失敗允許請求通過
    ...
    async def dispatch(self, request: Request, call_next) -> Response:
        ...
        except Exception as e:  # intentional catch-all: fail-open
