...
<header class="navbar bg-base-100 shadow-md border-b border-base-200">
  <div class="w-full px-3 md:px-6">
    <!-- 左側：聊天室標題 -->
    <div class="flex-1">
      <a href="/app/rooms" class="btn btn-ghost text-lg md:text-xl font-bold text-primary hover:bg-primary/10 hover:text-primary transition-all px-2 md:px-4">
      ...
      <div class="flex-none flex items-center gap-1 md:gap-2">
        ...
        <div class="dropdown dropdown-start">
          ...
          <ul tabindex="0" role="menu" class="dropdown-content menu bg-base-100 rounded-box z-[1] w-52 p-2 shadow">
            <li class="menu-title px-0 py-2 pointer-events-none">
            ...
            <li>
              <button onclick={(e: MouseEvent) => { e.stopPropagation(); showNotificationSettings = true; }} class="flex items-center w-full">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
