...
export interface WSRoomUsersMessage {
  type: 'room_users';
  users: User[];
  global_online_user_ids?: string[];
  timestamp: string;
  room_id: string;
  online_only?: boolean;
}

export interface WSMessageHistoryMessage {
...
export interface WSUserStatusChangedMessage {
...
/** notification_status_changed 事件的 data 欄位結構 */
...
export interface WSNotificationStatusChangedMessage {
  type: 'notification_status_changed';
  data: NotificationStatusData;
}

export interface WSReadStatusResponseMessage {
...
export interface WSNotificationStatsUpdateMessage {
...
export interface WSRoomCreatedMessage {
  type: 'room_created';
  room: RoomSummary;
  creator_id: string;
}

export interface WSRoomUpdatedMessage {
  type: 'room_updated';
  room: RoomSummary;
}
...
export type WebSocketMessage =
  ...
  | WSUserJoinedMessage
  | WSUserLeftMessage
  | WSUserStatusChangedMessage
  | WSPongMessage
  | WSNotificationMessage
  | WSNotificationStatusChangedMessage
  | WSReadStatusResponseMessage
  | WSNotificationStatsUpdateMessage
